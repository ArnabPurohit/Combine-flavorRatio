void FR_perBin_AllYears_new()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Nov  6 01:00:13 2021) by ROOT version 6.12/07
   TCanvas *c = new TCanvas("c", "c",0,0,800,800);
   c->SetHighLightColor(2);
   c->Range(1.965074,-0.25,3.644855,2.25);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogx();
   ...
   TH1F *Graph_Graph3001 = new TH1F("Graph_Graph3001","Graph",100,180,3830);
   Graph_Graph3001->SetMinimum(0.2179023);
   Graph_Graph3001->SetMaximum(1.156464);
